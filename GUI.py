...
if __name__=="__main__":
    ...
    lbl1.place(x=400,y=0)       # Position school logo Image
    ...
    txt = scrolledtext.ScrolledText(root,width=150,height=28,background = '#fff8dc', foreground ="black",font=("Aria bold",11))
